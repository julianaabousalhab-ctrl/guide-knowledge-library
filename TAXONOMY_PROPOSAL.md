...
- 3.3 XP & MAP Incentives
- 3.4 Maintaining Momentum
- 3.5 Motivation Planning & Iteration
...
- 5.3 Workshop Coaching
- 5.4 LifeSkills Development
...
- 6.1.2 Energy & Excitement
- 6.1.3 Guide Delivery
- 6.1.4 Student Engagement
- 6.1.5 Student Understanding
- 6.1.6 Student Application
- 6.1.7 Reflection
- 6.1.8 Closing

## 6.2 Townhalls

- 6.2.1 Student Ownership
- 6.2.2 Decision Making
- 6.2.3 Student Voice
- 6.2.4 Guide Facilitation

## 6.3 Daily Closings

- 6.3.1 Student Recognition
- 6.3.2 Community Reflection
- 6.3.3 Community Celebration
- 6.3.4 Culture Building Ritual
...
The following areas are intentionally excluded from this taxonomy because they are operational, administrative, or outside the Guide knowledge domain.
...
- Organize knowledge by **topic rather than source**.
- Support efficient retrieval of Guide knowledge.
- Allow BrainLifts to be attached to any taxonomy node.
- Scale as new Guide resources become available.
- Encourage reusable coaching insights across multiple sources.
