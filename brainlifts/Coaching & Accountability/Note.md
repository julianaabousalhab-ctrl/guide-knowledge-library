# Node 2.1 — Goal Discovery & Goal Setting
...
- **Build the goal around an interest** — merged into personally meaningful goal discovery rather than retained separately.
- **Create an action plan for the goal** — placed under Action Planning rather than Goal Setting.
...
- **Have the student restate the commitment** — merged into co-create and confirm the accountability agreement.
- **Call the student a leader or role model** — not included as evidence unless the student received a real responsibility.
- **Apply a consequence after a miss** — not included as a repair pathway unless the student also learned how to repair the situation and rebuild trust.
- **Distinguish incapacity from unwillingness** — handled within barrier diagnosis, adaptive coaching, and repair rather than retained separately.
...
- **End with one concrete action** — merged into execution conditions and evidence of completion.
- **Define how completion is known** — retained as part of execution conditions rather than as a separate pattern.
- **Create a full long-term plan** — not required when the student already had a clear next step.
...
- **Transfer success strategies across contexts** — merged into extracting a reusable learning strategy.
- **Adjust expectations for health or capacity** — handled under identifying performance conditions and adaptive coaching.
- **Label the student as distracted, unmotivated, or careless** — excluded because the node requires examining conditions or evidence rather than fixed judgments.
